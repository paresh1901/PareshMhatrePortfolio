...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/paresh1901/pareshportfolio.git
  ```
...
Note here that if you click [my portfolio](https://paresh1901.github.io/pareshportfolio/), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
...
If you can help us with these. Please don't hesitate to open an [pull request](https://github.com/paresh1901/pareshportfolio/pulls) or [issue](https://github.com/paresh1901/pareshportfolio/issues).
